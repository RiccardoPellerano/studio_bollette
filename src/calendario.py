...
def calendario(file, giorni_festivi):
    df_01 = pd.read_excel(file, sheet_name='Gennaio')
    df_02 = pd.read_excel(file, sheet_name='Febbraio')
    df_03 = pd.read_excel(file, sheet_name='Marzo')
    df_04 = pd.read_excel(file, sheet_name='Aprile')
    df_05 = pd.read_excel(file, sheet_name='Maggio')
    df_06 = pd.read_excel(file, sheet_name='Giugno')
    df_07 = pd.read_excel(file, sheet_name='Luglio')
    df_08 = pd.read_excel(file, sheet_name='Agosto')
    df_09 = pd.read_excel(file, sheet_name='Settembre')
    df_10 = pd.read_excel(file, sheet_name='Ottobre')
    df_11 = pd.read_excel(file, sheet_name='Novembre')
    df_12 = pd.read_excel(file, sheet_name='Dicembre')
